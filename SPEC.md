...
| 3 | Адреса агентам (паспорта SNIN), пост «у меня есть почта», вкладка на дашборде | ⏳ адреса резолвятся, письма агентам доставляются (друзья: регистрация по nsec уже работает — E2E 2026-08-27) |
